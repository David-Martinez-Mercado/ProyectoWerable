...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2025 a las 12:59:51
...
--
CREATE DATABASE IF NOT EXISTS `vital_monitor_private` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `vital_monitor_private`;
...
(15, 10, 'ENVIADO_C5', '{\"id\":10,\"id_dispositivo\":\"ESP32-001\",\"tipo_alerta\":\"extravio\",\"descripcion\":\"Paciente extraviado\",\"ubicacion_lat\":null,\"ubicacion_lon\":null,\"estado\":\"PENDIENTE\",\"fecha_creacion\":\"2025-11-28 04:41:35\",\"fecha_actualizacion\":\"2025-11-28 04:41:35\",\"sincronizado_c5\":0,\"id_alerta_publica\":null,\"notas_c5\":null,\"nombre_paciente\":\"Mar\\u00eda Gonz\\u00e1lez\",\"edad\":72,\"enfermedades_cronicas\":\"Hipertensi\\u00f3n, Diabetes\",\"contacto_emergencia\":\"6182384569\",\"direccion_residencia\":\"Direcci\\u00f3n no especificada\"}', NULL, '2025-11-28 10:41:36'),
(16, 10, 'ACTUALIZADO_DESDE_C5', NULL, '{\"estado_nuevo\":\"RESUELTA\",\"notas_c5\":\"\",\"fecha_actualizacion\":\"2025-11-28 11:42:08\"}', '2025-11-28 10:42:08'),
(17, 10, 'ACTUALIZADO_DESDE_C5', NULL, '{\"estado_nuevo\":\"RESUELTA\",\"notas_c5\":\"\",\"fecha_actualizacion\":\"2025-11-28 11:42:11\"}', '2025-11-28 10:42:11'),
(18, 11, 'ENVIADO_C5', '{\"id\":11,\"id_dispositivo\":\"ESP32-001\",\"tipo_alerta\":\"extravio\",\"descripcion\":\"Paciente extraviado\",\"ubicacion_lat\":null,\"ubicacion_lon\":null,\"estado\":\"PENDIENTE\",\"fecha_creacion\":\"2025-11-28 04:42:23\",\"fecha_actualizacion\":\"2025-11-28 04:42:23\",\"sincronizado_c5\":0,\"id_alerta_publica\":null,\"notas_c5\":null,\"nombre_paciente\":\"Mar\\u00eda Gonz\\u00e1lez\",\"edad\":72,\"enfermedades_cronicas\":\"Hipertensi\\u00f3n, Diabetes\",\"contacto_emergencia\":\"6182384569\",\"direccion_residencia\":\"Direcci\\u00f3n no especificada\"}', NULL, '2025-11-28 10:42:24'),
(19, 11, 'ACTUALIZADO_DESDE_C5', NULL, '{\"estado_nuevo\":\"PENDIENTE\",\"notas_c5\":\"\",\"fecha_actualizacion\":\"2025-11-28 11:42:33\"}', '2025-11-28 10:42:33'),
(20, 11, 'ACTUALIZADO_DESDE_C5', NULL, '{\"estado_nuevo\":\"RESUELTA\",\"notas_c5\":\"\",\"fecha_actualizacion\":\"2025-11-28 11:42:37\"}', '2025-11-28 10:42:37');
...
(10, 'ESP32-001', 'extravio', 'Paciente extraviado', NULL, NULL, 'RESUELTA', '2025-11-28 10:41:35', '2025-11-28 10:42:11', 1, 22, ''),
(11, 'ESP32-001', 'extravio', 'Paciente extraviado', NULL, NULL, 'RESUELTA', '2025-11-28 10:42:23', '2025-11-28 10:42:37', 1, 23, '');
...
('ESP32-001', 1, 'María González', '1950-01-01', 'Dirección no especificada', NULL, '6182384569', 72, 'Hipertensión, Diabetes', 'offline', '2025-11-26 00:38:39', '2025-11-28 09:23:19');
...
--
-- Base de datos: `vital_monitor_public`
--
CREATE DATABASE IF NOT EXISTS `vital_monitor_public` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `vital_monitor_public`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `alertas_c5`
--
...
CREATE TABLE `alertas_c5` (
  ...
  `unidades_asignadas` varchar(255) DEFAULT NULL,
  `fecha_reporte` timestamp NOT NULL DEFAULT current_timestamp(),
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `notas_actualizacion` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `alertas_c5`
--

INSERT INTO `alertas_c5` (`id`, `id_alerta_privada`, `id_dispositivo`, `tipo_emergencia`, `nombre_paciente`, `edad`, `enfermedades_cronicas`, `contacto_emergencia`, `direccion_residencia`, `direccion_recoleccion`, `ubicacion_lat`, `ubicacion_lon`, `estado`, `tiempo_respuesta`, `unidades_asignadas`, `fecha_reporte`, `fecha_actualizacion`, `notas_actualizacion`) VALUES
(1, 1, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', 'No especificado', 19.43260700, -99.13320800, 'RESUELTA', 24, 'AMB-002', '2025-11-27 22:26:35', '2025-11-27 22:51:02', ''),
(2, 6, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'CANCELADA', NULL, 'AMB-002', '2025-11-28 02:49:42', '2025-11-28 02:51:07', 'Va volaando'),
(3, 7, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'RESUELTA', 0, '', '2025-11-28 03:19:16', '2025-11-28 03:19:39', ''),
(4, 8, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'RESUELTA', 4, '', '2025-11-28 03:21:03', '2025-11-28 03:25:04', ''),
(5, 9, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'RESUELTA', 4, '', '2025-11-28 03:21:03', '2025-11-28 03:25:09', ''),
(6, 10, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'RESUELTA', 4, '', '2025-11-28 03:21:03', '2025-11-28 03:25:16', ''),
(7, 11, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'RESUELTA', 1, '', '2025-11-28 03:27:42', '2025-11-28 03:28:57', ''),
(8, 12, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'CANCELADA', NULL, '', '2025-11-28 03:30:41', '2025-11-28 03:33:06', ''),
(9, 13, 'ESP32-001', 'Persona Extraviada', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'RESUELTA', 0, '', '2025-11-28 03:55:56', '2025-11-28 03:56:07', ''),
(10, 14, 'ESP32-001', 'Persona Extraviada', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, 19.43260700, -99.13320800, 'RESUELTA', 0, '', '2025-11-28 03:55:56', '2025-11-28 03:56:12', ''),
(11, 18, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 04:59:42', '2025-11-28 05:00:11', ''),
(12, 19, 'ESP32-001', 'Persona Extraviada', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 05:00:37', '2025-11-28 05:00:47', ''),
(13, 1, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 05:09:03', '2025-11-28 05:09:16', ''),
(14, 1, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'EN LUGAR', NULL, '', '2025-11-28 05:40:00', '2025-11-28 05:40:27', ''),
(15, 2, 'ESP32-001', 'Persona Extraviada', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 05:41:03', '2025-11-28 05:41:17', ''),
(16, 3, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 49, '', '2025-11-28 05:43:35', '2025-11-28 06:33:06', ''),
(17, 4, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 06:33:21', '2025-11-28 06:33:52', ''),
(18, 5, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 5, '', '2025-11-28 06:44:46', '2025-11-28 06:50:28', ''),
(19, 6, 'ESP32-001', 'Persona Extraviada', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 06:50:45', '2025-11-28 06:50:53', ''),
(20, 7, 'ESP32-001', 'Emergencia Médica', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 06:55:24', '2025-11-28 06:55:46', ''),
(21, 8, 'ESP32-001', 'Persona Extraviada', 'María González', 72, 'Hipertensión, Diabetes', 'Contacto no especificado', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 06:57:00', '2025-11-28 06:57:23', ''),
(22, 10, 'ESP32-001', 'Persona Extraviada', 'María González', 72, 'Hipertensión, Diabetes', '6182384569', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 10:41:36', '2025-11-28 10:42:11', ''),
(23, 11, 'ESP32-001', 'Persona Extraviada', 'María González', 72, 'Hipertensión, Diabetes', '6182384569', 'Dirección no especificada', NULL, NULL, NULL, 'RESUELTA', 0, '', '2025-11-28 10:42:24', '2025-11-28 10:42:37', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `estadisticas_tiempos`
--
...
CREATE TABLE `estadisticas_tiempos` (
  ...
  `total_casos` int(11) DEFAULT 0,
  `fecha_actualizacion` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `estadisticas_tiempos`
--

INSERT INTO `estadisticas_tiempos` (`id`, `tipo_emergencia`, `tiempo_promedio`, `tiempo_minimo`, `tiempo_maximo`, `total_casos`, `fecha_actualizacion`) VALUES
(1, 'Emergencia Médica', 6, 0, 24, 6, '2025-11-28 03:28:57'),
(2, 'Persona Extraviada', 12, 5, 25, 0, '2025-11-27 17:46:43'),
(3, 'Emergencia Médica', 10, 0, 49, 9, '2025-11-28 06:33:06'),
(4, 'Emergencia Médica', 8, 0, 49, 11, '2025-11-28 06:50:28');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `unidades_emergencia`
--
...
--
-- Volcado de datos para la tabla `unidades_emergencia`
--

INSERT INTO `unidades_emergencia` (`id`, `numero_unidad`, `tipo_unidad`, `estado`, `ubicacion_lat`, `ubicacion_lon`, `operador_asignado`, `ultima_actualizacion`) VALUES
(1, 'AMB-001', 'ambulancia', 'disponible', 19.43260000, -99.13320000, 'Juan Pérez', '2025-11-28 03:30:00'),
(2, 'AMB-002', 'ambulancia', 'disponible', 19.43400000, -99.13450000, 'María González', '2025-11-28 03:30:05'),
(3, 'PAT-001', 'patrulla', 'disponible', 19.43300000, -99.13200000, 'Roberto Sánchez', '2025-11-27 17:46:43'),
(4, 'PAT-002', 'patrulla', 'disponible', 19.43150000, -99.13500000, 'Laura Martínez', '2025-11-27 17:46:43');
...
--
-- Volcado de datos para la tabla `usuarios_c5`
--

INSERT INTO `usuarios_c5` (`id`, `username`, `password`, `nombre`, `rol`, `turno`, `estado`, `fecha_creacion`) VALUES
(1, 'operador1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Ana García', 'operador', 'matutino', 'activo', '2025-11-27 17:46:43'),
(2, 'supervisor1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Carlos López', 'supervisor', 'matutino', 'activo', '2025-11-27 17:46:43'),
(3, 'admin_c5', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrador C5', 'admin', 'matutino', 'activo', '2025-11-27 17:46:43');
...
--
-- Indices de la tabla `alertas_c5`
--
ALTER TABLE `alertas_c5`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_estado` (`estado`),
  ADD KEY `idx_fecha` (`fecha_reporte`);

--
-- Indices de la tabla `estadisticas_tiempos`
--
ALTER TABLE `estadisticas_tiempos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `unidades_emergencia`
--
ALTER TABLE `unidades_emergencia`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `alertas_c5`
--
ALTER TABLE `alertas_c5`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `estadisticas_tiempos`
--
ALTER TABLE `estadisticas_tiempos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `unidades_emergencia`
--
ALTER TABLE `unidades_emergencia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
